...
async function run() {
    ...
    // 3. Define Prompt for Versus Comparison
    // "Electric Cars vs. Gas Cars: The Ultimate Comparison."
    // Should trigger 'versus_split' template.
    const prompt = "Electric Cars vs. Gas Cars: The Ultimate Comparison.";
    ...
    try {
        const context = {
            ...
            targetAudience: 'Car Buyers',
            topic: 'Automotive Debate'
        };
